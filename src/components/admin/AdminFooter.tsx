...
export function AdminFooter(_props: AdminFooterProps) {
  ...
  return (
    <footer className="fixed inset-x-0 bottom-0 z-[60] flex h-14 min-h-14 flex-shrink-0 items-center justify-between gap-4 border-t border-gray-800 bg-black px-4 sm:px-6 print:hidden">
